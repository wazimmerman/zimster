...
for (const relative of [
  ...
  'scripts/run-control.mjs', 'scripts/lib/run-control.mjs', 'scripts/lib/run-summary.mjs',
  'scripts/lib/control-plane-mutation.mjs',
  'scripts/verify.mjs', 'scripts/docs-hygiene.mjs',
  'scripts/archive-safety.mjs', 'scripts/secret-scan.mjs',
  ...
  'schemas/review-lifecycle.schema.json', 'schemas/assurance-accounting.schema.json',
  'schemas/completion-decision.schema.json',
  'schemas/context-index.schema.json', 'schemas/work-journal.schema.json',
  'schemas/run-state.schema.json', 'schemas/recovery-checkpoint.schema.json',
