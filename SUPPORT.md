...
Use GitHub Issues for reproducible bugs and workflow proposals. Include the
harness, version, model, operating system, Zimster version, minimal
reproduction and, when relevant, agent count, turns, elapsed time, token usage,
